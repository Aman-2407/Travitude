...
<body>
    <div class="jumbotron text-center">
        ...
        <p class="lead"><strong>"Payment Recived."</p></strong>
        <hr  style="border-top: 2px solid #ff304f;">
        <p>
         <h4>Any Query <a href="getintouch.php" style="color: red;">Contact us </a> </h4>
        </p>
        <div class="wrap">
        <div class="exp">
          <a href="gallery.php" class="b1">Explore More</a>
            </div>
            </div>
